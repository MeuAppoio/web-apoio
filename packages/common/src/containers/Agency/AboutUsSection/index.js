...
import GroupImage1 from "../../../assets/image/agency/group/grupo1.jpg";
import GroupImage2 from "../../../assets/image/agency/group/grupo2.jpg";
import GroupImage3 from "../../../assets/image/agency/group/grupo3.jpg";
      ...
      <Box className="row" {...row}>
        ...
        <Box className="col" {...col}>
          <Box {...textArea}>
            <FeatureBlock
              title={
                <Heading content="Você no seu máximo sempre!" {...title} />
              }
              description={
                <Text
